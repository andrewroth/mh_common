    ...
    module MinistryInvolvement
      def self.included(base)
        base.class_eval do
          ...
          validates_uniqueness_of :person_id, :scope => [:ministry_id, :end_date], :message => "This person already has a ministry involvement at this ministry. Please edit or remove the existing ministry involvement."
        end
